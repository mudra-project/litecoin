...
const QString BITCOIN_IPC_PREFIX("mudracoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/mudracoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/mudracoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/mudracoin-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start mudracoin: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("mudracoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'mudracoin://' is not a valid URI. Use 'mudracoin:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Mudracoin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
