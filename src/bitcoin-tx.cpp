...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " mudracoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  mudracoin-tx [options] <hex-tx> [commands]  Update hex-encoded mudracoin transaction\n" +
            "or:     mudracoin-tx [options] -create [commands]   Create hex-encoded mudracoin transaction\n" +
            "\n";
