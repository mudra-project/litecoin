# Support for Output Descriptors in Mudracoin Core

Since Mudracoin Core v0.17, there is support for Output Descriptors in the
...
on Mudracoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Mudracoin Core wallets, a convenience function `combo` is
