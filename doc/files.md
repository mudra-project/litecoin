...
* mudracoin.conf: contains configuration settings for mudracoind or mudracoin-qt
* mudracoind.pid: stores the process id of mudracoind while running
...
* debug.log: contains debug information and general logging generated by mudracoind or mudracoin-qt
